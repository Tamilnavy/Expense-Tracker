...
const AuthLayout = ({children}) => {
  return (
    ...
    <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <div className="w-48 h-56 rounded-[40px] border-20 border-fuchsia-600 absolute top-[35%] -right-10"/>
        <div className="w-48 rounded-[40px] bg-violet-500 absolute -bottom-7 -left-5"/>
...
const SatsInfoCard =({icon, label, value, color})=>{
